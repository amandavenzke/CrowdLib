...
public class S3Config {
	...
	public AmazonS3 amazonS3() {
		AWSCredentials credenciais = new BasicAWSCredentials(crowdLibApiProperty.getS3().getAccessKeyId(),
		...
		if (!amazonS3.doesBucketExistV2(crowdLibApiProperty.getS3().getBucket())) {
			amazonS3.createBucket(new CreateBucketRequest(crowdLibApiProperty.getS3().getBucket()));
			...
			amazonS3.setBucketLifecycleConfiguration(crowdLibApiProperty.getS3().getBucket(), configuration);
		}
